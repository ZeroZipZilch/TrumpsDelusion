...
Game.prototype.preLoadImages = function()
{
	...
	popup.set("Welcome to Trumps Delusion. Defeat Trump with common sense and reasonable arguments. ;: Use the left and right arrow keys to move around, and jump with the space bar. Use Z, X, C and V to use your abilities. ;: You'll gain the C and V abilities on level 5 and 9. Use Z to create platforms while in the air to reach up to Trump, and X to argument against his face. ;: [Press Enter to continue]", 'full', false);
